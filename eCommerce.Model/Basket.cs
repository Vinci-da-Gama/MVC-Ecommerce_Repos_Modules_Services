...
namespace eCommerce.Models
{
    public class Basket : IBasket
    {
        ...
        {
            get { return _basketItems.ConvertAll(i => (IBasketItem)i); }
        }
        public virtual ICollection<BasketItem> BasketItems
        {
            get { return _basketItems; }
            set { _basketItems = value.ToList(); }
        }

        public virtual ICollection<IBasketVoucher> IBasketVouchers
        {
            get { return _basketVouchers.ConvertAll(i => (IBasketVoucher)i); }
        }
        public virtual ICollection<BasketVoucher> BasketVouchers
        {
            get { return _basketVouchers; }
            set { _basketVouchers = value.ToList(); }
        }

        public void AddBasketItem(IBasketItem item)
        {
            this._basketItems.Add((BasketItem)item);
        }

        public void AddBasketVoucher(IBasketVoucher voucher)
        {
            this._basketVouchers.Add((BasketVoucher)voucher);
        }
    }
}
